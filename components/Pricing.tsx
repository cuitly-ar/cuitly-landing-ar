...
const Pricing = () => {
  ...
  const plans = [
    {
      ...
      features: [
        ...
        'Reintento automático si ARCA (ex AFIP) está caído',
    ...
    },
    {
      ...
      features: [
        ...
        'Recordatorios automáticos de vencimientos ARCA (ex AFIP) y pagos del Monotributo',
        'Soporte prioritario en WhatsApp',
        'Personalización del comprobante',
      ],
      highlighted: true,
      comingSoon: false,
    },
  ...
  const comparisonData = [
    ...
    { feature: 'Reintento automático si ARCA (ex AFIP) está caído', emprendedor: true, negocios: true, business: true },
    ...
    { feature: 'Recordatorios automáticos de vencimientos ARCA (ex AFIP)', emprendedor: false, negocios: true, business: true },
